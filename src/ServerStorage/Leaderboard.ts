const Leaderboard = {
  setStat(props: { player: Player; statName: string; value: number }): void {},
}

function setLeaderboardStat(props: Parameters<typeof Leaderboard.setStat>['0']): void {
...
Leaderboard.setStat = setLeaderboardStat
